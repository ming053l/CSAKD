...
from models.KQD_Large import Teacher , Student
...
def parse_args():
    ...
    parser.add_argument('--resume_ind', type=int, default=600)
    parser.add_argument('--resume_ckpt', type=str, default="KD_4bn_Band4_LARGE_8866_2444")
    ...
    parser.add_argument('--student_layers', type=list, default=[2,4,4,4])
    ...
    parser.add_argument("--prefix", type=str, default="KD_4bn_Band4_LARGE_8866_2444")  
...
def trainer(args):
    ...
    optimizer_t = optim.AdamW(model_t.parameters(), lr=args.lr, weight_decay=args.weight_decay)  
    ...
    optimizer_s = optim.AdamW(model.parameters(), lr=args.lr, weight_decay=args.weight_decay)  
    ...
    best_sam = 99
    best_sam_s = 99
    iteration = resume_ind*len(train_loader)
    bploss = BPLoss()
    samloss = SAMLoss()
